...
- [x] **T0.1** — ORM tranché : **Prisma** (schéma initialisé dans `apps/api/prisma/schema.prisma`, reflète spec.md §1). Provider email et hébergement UE restent différés (non bloquants avant Phase 6).
